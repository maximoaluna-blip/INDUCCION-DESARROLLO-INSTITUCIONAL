...
7. **`paragraph`** — _"**Qué cubre:** el vínculo del nivel correspondiente con la **OMMS** (Organización Mundial del Movimiento Scout), con la **Región Scout Interamericana**, con **OSN de otros países**, y con organismos multilaterales (ONU, UNESCO, UNICEF). A nivel de grupo, este ámbito generalmente se experimenta como **participación en proyectos mundiales** (Scouts for SDGs, Tide Turners, Earth Tribe, etc.) más que como diplomacia formal."_
...
4. **`paragraph`** — _"**Qué cubre:** las 3 áreas transversales de riesgo en el scoutismo según la doctrina vigente: **ambiente seguro** (A Salvo del Peligro, prevención de abuso), **protección financiera y patrimonial** (cuidar la plata y los bienes del grupo), **actividades seguras** (campamentos, salidas, transporte, primeros auxilios). El **ciclo de gestión del riesgo** tiene 4 pasos: identificación, análisis, tratamiento y monitoreo."_
...
7. **`paragraph`** — _"**Qué cubre:** los órganos de control (que viste en el Curso 3) y todo el sistema de **estímulos y reconocimientos** del scoutismo. Esto incluye el **Manual de Estímulos Nacionales** y el **Manual de la Orden al Mérito Scout** (ambos del CSN 2022), que regulan los reconocimientos a dirigentes y voluntarios destacados. **Premia lo que funciona, vigila lo que se desvía.**"_
