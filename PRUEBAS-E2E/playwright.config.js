 ...
 * La URL base apunta a la carpeta de cursos de la linea Desarrollo Institucional.
 */
const BASE_URL =
  process.env.ASC_BASE_URL ||
  'https://maximoaluna-blip.github.io/INDUCCION-DESARROLLO-INSTITUCIONAL/02-Plataforma-Web/';
